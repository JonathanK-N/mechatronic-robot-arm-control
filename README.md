...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:jonathan.kakesa@polymtl.ca)
...
|------------|----------------------|------------------|---------------|--------------------|
| 🎯 Précision répétitive | `±0.22 mm` | `≤ ±0.3 mm` | 🟢 **DÉPASSÉ** | ![](https://progress-bar.dev/127/?scale=100&title=+27%25&width=100&color=00ff00) |
| ⚡ Temps cycle pick/place | `1.65 s` | `≤ 1.8 s` | 🟢 **ATTEINT** | ![](https://progress-bar.dev/108/?scale=100&title=+8%25&width=100&color=00ff00) |
| 💪 Charge utile nominale | `3.2 kg` | `3 kg` | 🟢 **DÉPASSÉ** | ![](https://progress-bar.dev/107/?scale=100&title=+7%25&width=100&color=00ff00) |
...
graph TB
    ...
    subgraph "📊 Analytics Layer"
        L[COBOL KPI Engine] --> M[OEE Calculator]
        M --> N[Maintenance Scheduler]
        N --> O[Energy Monitor]
    end
    
    subgraph "🤖 AI Layer"
        P[Prolog Expert System] --> Q[Fault Diagnostics]
        Q --> R[Process Planner]
        R --> S[Predictive Analytics]
    end
    
    subgraph "🔌 Hardware Layer"
        T[STM32F4 Microcontroller] --> U[CAN Bus Network]
        U --> V[BLDC Motors + ODrive]
        V --> W[Absolute Encoders]
        W --> X[FSR Gripper]
        X --> Y[Safety Sensors]
    end
...
|---------------------|------------------|--------------|--------------------|--------------------|
| ![C++](https://img.shields.io/badge/C++-17-blue?style=for-the-badge&logo=cplusplus) | `main.cpp`<br/>`pid_controller.h`<br/>`mqtt_config.h` | Contrôle temps réel<br/>MQTT telemetry<br/>Profils dynamiques | ⚡ 50Hz<br/>📡 Real-time<br/>🔄 Adaptive | ![](https://progress-bar.dev/95/?title=Expert) |
| ![Python](https://img.shields.io/badge/Python-3.11-green?style=for-the-badge&logo=python) | `digital_twin.py` | Cinématique directe/inverse<br/>Validation workspace<br/>Export MES | 🔮 Predictive<br/>📊 Analytics<br/>🔗 Integration | ![](https://progress-bar.dev/85/?title=Advanced) |
| ![COBOL](https://img.shields.io/badge/COBOL-Legacy-orange?style=for-the-badge) | `factory_kpi.cbl`<br/>`maintenance_scheduler.cbl` | KPI consolidation<br/>Maintenance préventive<br/>Reporting enterprise | 📊 Enterprise<br/>🔧 Predictive<br/>📈 Analytics | ![](https://progress-bar.dev/75/?title=Professional) |
| ![Prolog](https://img.shields.io/badge/Prolog-SWI-purple?style=for-the-badge) | `diagnostics.pl`<br/>`process_planner.pl` | IA diagnostics<br/>Planification intelligente<br/>Système expert | 🤖 AI Expert<br/>🧠 Reasoning<br/>⚡ Real-time | ![](https://progress-bar.dev/90/?title=Expert) |
...
<td align="center">
<img src="docs/images/atlas_cycloidal.png" width="250px" alt="Réducteur"/><br/>
...
<td align="center">
<img src="docs/images/atlas_end_effector.png" width="250px" alt="Effecteur"/><br/>
...
sequenceDiagram
    ...
    O->>H: 🚀 Démarrage production
    H->>C: Initialisation système
    C->>C: 🔧 Calibration zéro-couple
    C->>R: Test axes + capteurs
    R-->>C: ✅ Status OK
    
    loop Cycle Production
        C->>P: 📡 Positions temps réel
        P->>P: 🔮 Validation cinématique
        P-->>C: ✅ Trajectoire validée
        C->>R: 🎯 Commandes moteurs
        R->>R: 🤏 Exécution pick/place
        R-->>C: 📊 Télémétrie
        C->>B: 📝 Logs opérationnels
        B->>B: 📈 Calcul KPI temps réel
        L->>L: 🔍 Surveillance continue
        alt Anomalie détectée
            L->>H: ⚠️ Alerte contextuelle
            H->>O: 🚨 Notification opérateur
        end
    end
    
    B->>H: 📊 Rapport de shift
    H->>O: 📈 Dashboard KPI
```
...
![Contributions](https://img.shields.io/badge/Commits-247+-brightgreen?style=for-the-badge)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Jonathan%20Kakesa-0077B5?style=for-the-badge&logo=linkedin)](https://linkedin.com/in/jonathan-kakesa)
[![Email](https://img.shields.io/badge/Email-Contact-D14836?style=for-the-badge&logo=gmail)](mailto:jonathan.kakesa@polymtl.ca)
[![Portfolio](https://img.shields.io/badge/Portfolio-Website-FF5722?style=for-the-badge&logo=firefox)](https://jonathan-kakesa.dev)
...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=16&duration=2000&pause=1000&color=36BCF7&center=true&vCenter=true&width=500&lines=Made+with+%E2%9D%A4%EF%B8%8F+and+lots+of+%E2%98%95+at+Polytechnique;Innovation+M%C3%A9catronique+Industrielle;Merci+pour+votre+int%C3%A9r%C3%AAt+!" alt="Footer Typing" />
